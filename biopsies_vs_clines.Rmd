...
plotMDS(mymds,pch=19,cex=3,col=cols,main="Cell lines and Tumour biopsies",xlim=c(XMIN,XMAX))
...
# ggplot(gsea_plots, aes(x = s.dist, y = reorder(set, s.dist), color = p.adjustANOVA, size = setSize, shape=dataset)) + 
#   facet_wrap(~plot, ncol=1, nrow=2, scales = "free") +
#   force_panelsizes(rows = c(1, 2)) +
#   geom_point(stat = 'identity', alpha=0.75) + 
#   scale_size_continuous(breaks=c(10, 25, 50, 100, 500))+
#   scale_color_viridis(option="mako", direction=1,limits = c(0, 0.05)) +
